...
- Man page: add --lock-timeout flag, plugin edit command, and fix lock wait behavior description
- Homebrew formula head URL now points to GitHub remote instead of local path
...
- Skip plugin setup header for plugins with no config entries or secrets
...
- Fork/COW pipeline documentation (feature not yet implemented)
