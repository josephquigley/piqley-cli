...
struct SecretPrunerTests {
    ...
    func prunesOrphanedSecrets() throws {
        let tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("piqley-pruner-\(UUID().uuidString)")
        let configDir = tempDir.appendingPathComponent("config")
        let workflowDir = tempDir.appendingPathComponent("workflows")
        ...
        let workflowScanner = WorkflowFileScanner(workflowsDirectory: workflowDir)
